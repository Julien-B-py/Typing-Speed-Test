...
class Window(Tk):
    ...
    def bind_functions(self):
        ...
        # Catch all keypresses to trigger the game timer
    ...
    def compare_words(self, event):
        ...
        # Compare theses 2 values. If they match it means the user typed correctly and self.game.correct_answer will be True
